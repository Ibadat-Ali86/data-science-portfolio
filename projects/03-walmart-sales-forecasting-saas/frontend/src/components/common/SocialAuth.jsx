...
const SocialAuth = ({ onGoogleClick, onGitHubClick, isLoading = false }) => {
    const handleGoogleLogin = () => {
        if (onGoogleClick) {
            ...
            window.location.href = `${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/api/auth/login/google`;
        }
    };
        ...
        <div className="space-y-3 mb-6">
            ...
            <div className="relative mt-6">
                ...
                <div className="relative flex justify-center text-sm">
                    <span className="px-4 text-gray-500 bg-white font-medium">Or continue with email</span>
                </div>
            </div>
        </div>
    );
